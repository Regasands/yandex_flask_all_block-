...
def get_one_jobs(jobs_id):
    ...
    return jsonify(
            {
            'job': job.to_dict(only=('id', 'job', 'work_size', 'team_leader', 'collaborators', 'start_date', 'end_date', 'is_finished'))
        }
    )
...
def get_jobs():
    ...
    return jsonify(
            {
            'job': [job.to_dict(only=('id', 'job', 'work_size', 'team_leader', 'collaborators', 'start_date', 'end_date', 'is_finished')) for job in jobs]
        }
    )
